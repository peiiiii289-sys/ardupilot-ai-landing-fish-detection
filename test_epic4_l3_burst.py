...
def main():
    ...
    print(">>> 目標：Story 4.3 boundary / protection 最終驗證")
    print(">>> 請先在 MAVProxy 做：")
    print(">>> module load message")
    print(">>> arm throttle force")
    print(">>> mode QHOVER")
    print(">>> rc 3 1600")
    print(">>> 等 PHASE0 穩定後，手動打一次：mode QLAND")
    ...
    stream_phase(
        ...
        roll=0.00, pitch=-0.03, yaw=0.03,
        x=1.00, y=0.50, z=-2.00, dist=2.50
    )

    # Phase 1: L1 boundary
    print(">>> 目標：這段理想上應看到 L1=1, L2=0, L3=0")
    stream_phase(
        m, t0,
        name="PHASE1_L1_BOUNDARY",
        hz=10.0,
        duration_sec=6,
    ...
    # Phase 2: L2 boundary
    print(">>> 目標：這段理想上應看到 L2=1，並出現 AI_LANDING_ABORT_L2 / AI_GO_AROUND")
    stream_phase(
        m, t0,
        name="PHASE2_L2_BOUNDARY",
        hz=10.0,
        duration_sec=8,
